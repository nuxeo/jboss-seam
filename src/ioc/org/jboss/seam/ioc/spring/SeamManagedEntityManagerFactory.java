...
public class SeamManagedEntityManagerFactory implements EntityManagerFactory,
    ...
    public SeamManagedEntityManagerFactory(String seamPersistenceContextName) {
        if (seamPersistenceContextName == null
                || "".equals(seamPersistenceContextName)) {
            throw new IllegalArgumentException(
                    "persistenceContextName cannot be null");
        }
        persistenceContextName = seamPersistenceContextName;
    }
    ...
    public EntityManager createEntityManager() {
        ...
        // Creating Proxy of EntityManager to ensure we implement all the
        // interfaces
        return (EntityManager) Proxy.newProxyInstance(getClass()
                .getClassLoader(), ClassUtils.getAllInterfaces(em),
                new SeamManagedPersistenceContextHandler(em));
    }

    @Override
    public EntityManager createEntityManager(Map properties) {
        // Not really sure if I should throw an exception here or just ignore
        // the Map
     ...
     *
     */
    public static class SeamManagedPersistenceContextHandler implements
        ...
        public Object invoke(Object proxy, Method method, Object[] args)
            ...
            if (closed) {
                throw new IllegalStateException(
                        "This PersistenceContext is closed.");
            }
    ...
    public CriteriaBuilder getCriteriaBuilder() {
        throw new UnsupportedOperationException("hibernate 4 migration");
    }
